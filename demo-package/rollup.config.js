  ...
  plugins: [
    ...
    }),
    {
      ...
      generateBundle() {
        ...
        fs.copyFileSync(
          "./wasm/demo-package_bg.wasm",
          `dist/wasm/demo-package.wasm`,
        );
        ...
        // on the rust code
        fs.copyFileSync(
          "./wasm/demo-package_bg.wasm.d.ts",
          `dist/wasm/demo-package.wasm.d.ts`,
        );
        fs.copyFileSync(
          path.resolve("./wasm/demo-package.d.ts"),
          path.resolve(`dist/wasm/demo-package.d.ts`),
        );
      },
    },
  ],
